      	...
      	<div class="row " class="col-md-12 col-lg-12 col-sm-12 " style="background:white; margin: 10px">
      		<form action="{{route('projects.update',[$project->id])}}" method="post" accept-charset="utf-8">
      			...
      			<div class="form-group">
      				...
      				<input type="text" class="form-control" id="project-name" required name="projectName" placeholder="Enter name" value="{{$project->name}}">
      				
      			</div>
      			<div class="form-group">
      				<label for="project-description">description<span class="required">*</span></label>
      				<textarea  class="form-control" id="project-description" required rows="4" name="projectDescription" placeholder="Enter description" style="resize: vertical;" >{{$project->description}}</textarea>
      			</div>
