        ...
        <div class="modal-body abv js-modalBody">
          <div class="att">
            <div class="bkt cj ca js-msgGroup">
              <a href="#" class="b os">
                <div class="oq">
                  <img class="rl bkp ru uk abc" src="img/avatar-fat.jpg">
                  <div class="or">
              ...
              <a href="#" class="b os">
                <div class="oq">
                  <img class="rl bkp ru uk abc" src="img/avatar-mdo.png">
                  <div class="or">
              ...
              <a href="#" class="b os">
                <div class="oq">
                  <img class="rl bkp ru uk abc" src="img/avatar-dhg.png">
                  <div class="or">
            ...
            <div class="ro aba js-conversation">
              <ul class="bkt bkz">
                <li class="oq blc abk">
                  ...
                  <img class="rl bkp ru uk abe" src="img/avatar-dhg.png">
                </li>
        ...
        <div class="modal-body abv">
          <div class="att">
            <ul class="bkt cj ca">
              <li class="b">
                <div class="oq zy">
                  <img class="bkp ru uk abc" src="img/avatar-fat.jpg">
                  <div class="or">
              ...
              <li class="b">
                <div class="oq zy">
                  <img class="bkp ru uk abc" src="img/avatar-dhg.png">
                  <div class="or">
                    <button class="cg kt ll zc">
                      <span class="c blp"></span> Follow
                    </button>
              ...
              <li class="b">
                <div class="oq zy">
                  <img class="bkp ru uk abc" src="img/avatar-mdo.png">
                  <div class="or">
                    <button class="cg kt ll zc">
                      <span class="c blp"></span> Follow
                    </button>
    ...
    <div class="dp">
      <div class="fj">
        <div class="mu blf abk">
          <div class="na" style="background-image: url(img/iceland.jpg);"></div>
          <div class="mv arx">
            <a href="{{ url('profile')}}">
              <img
                class="blg"
            ...
            <h6 class="mw">
              <a class="bjx" href="{{ url('profile')}}">Dave Gamache</a>
            </h6>
                 ...
                 <ul class="bkt aaw">
                  <li class="oq b acx">
                    ...
                    <div class="or">
                      <strong>TAREK: </strong>
                      Donec id elit non mi porta gravida at eget metus. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Donec ullamcorper nulla non metus auctor fringilla. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Sed posuere consectetur est at lobortis.
                      <form action="/insertcomment" method="post" accept-charset="utf-8">
                        
                        {{ csrf_field() }}

                        <div class="form-group">
                             
                      <textarea name=" body" placeholder="add comments" class="form-control" pattern="" required> </textarea> 
                          </div>
                         <button type="submit" class="btn btn-primary mb-2">AddComment</button>
                      </form>
                    </div>
                  </li>
                  </ul>
      ...
      <div class="fj">
        <div class="alert oj alert-dismissible ro sp" role="alert">
          ...
          <a class="oe" href="{{ url('profile')}}">Visit your profile!</a> Check your self, you aren't looking well.
        </div>
        ...
        <div class="mu abk ro sp">
          <div class="mv">
            ...
            <div data-grid="images" data-target-height="150">
              <img class="bkp" data-width="640" data-height="640" data-action="zoom" src="img/instagram_2.jpg">
            </div>
